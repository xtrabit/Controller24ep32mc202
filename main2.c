...
void __attribute__ ( ( interrupt, no_auto_psv ) ) _T1Interrupt (  )             // SPI output timer
    ...
    {
        count_t1 = 0;
        if (display_digit < 2) display_digit++;
...
void Test_spin(void)
{
    ...
    {
        if (gyro_value <= -0x0730 || gyro_value >= 0x0730)
        {
            test_timer_lsb = TMR4;
            ...
            test_timer_seconds = test_timer * 0.000031146323;//1557316
